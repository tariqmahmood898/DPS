...
import { DPS, PoolButton, SwapButton, VisitButton } from './Button';
  ...
  return (
    <div className="about-container">
      ...
      <div className="whitepaper-section">
        ...
        <a href={DPSpaper} className="download-link" target='_blank'>Download Whitepaper (PDF)</a>
      ...
      <div className="social-section">
        ...
        <div className="social-icons">
          <a href="https://t.me/dpstoken" target="_blank" rel="noopener noreferrer">
            <FontAwesomeIcon icon={faTelegram} size="2x" />
          </a>
          <a href="https://twitter.com/dpstoken" target="_blank" rel="noopener noreferrer">
            <FontAwesomeIcon icon={faTwitter} size="2x" />
          </a>
          <a href="https://facebook.com/dpstoken" target="_blank" rel="noopener noreferrer">
            <FontAwesomeIcon icon={faFacebook} size="2x" />
          </a>
          <a href="https://instagram.com/dpstoken" target="_blank" rel="noopener noreferrer">
