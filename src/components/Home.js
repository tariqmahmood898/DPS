...
import { PoolButton } from './Button'; // Import the Button component
  ...
  return (
    <div className="home-container">
      ...
      <div className="hero-section">
        <img src={ Wallet  } alt="DPS Crypto Token" className="hero-section" />
        <div className="hero-text">
          <h1>Future of Decentralized Finance with DPS</h1>
          <p> <strong>Decentralized Payment System (DPS) is a revolutionary crypto token built on the TON blockchain. </strong> <br />
